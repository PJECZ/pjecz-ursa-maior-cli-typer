...
app.add_typer(dgt_depositos_app, name="dgt-depositos")
app.add_typer(dgt_digitalizaciones_app, name="dgt-digitalizaciones")
app.add_typer(dgt_digitalizaciones_bitacoras_app, name="dgt-digitalizaciones-bitacoras")
app.add_typer(dgt_entregas_app, name="dgt-entregas")
app.add_typer(dgt_entregas_bitacoras_app, name="dgt-entregas-bitacoras")
app.add_typer(dgt_rutas_app, name="dgt-rutas")
